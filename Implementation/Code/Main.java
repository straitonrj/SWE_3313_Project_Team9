...
public class Main {
    ...
    public static void AddInventory(User TempUser){
        if(TempUser.getIsAdmin()){
            //UI will ask for title of car
            String t;
            //UI will ask for Description of car
            String d;
            //UI will ask for Price of car
            Double p;
            Inventory TempInventory = new Inventory(t,p,d);
            //Add to json inventory database
        }
    }
